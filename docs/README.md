...
历史专项问题和优化记录已统一移动到 [optimization-reports](./zh/optimization-reports/)：

- [调度总问题清单](./zh/optimization-reports/01-scheduling-issues.md)
- [调度慢问题优化指南](./zh/optimization-reports/02-scheduling-latency-optimization.md)
- [ZLM/FFmpeg 重构方案](./zh/optimization-reports/03-zlm-ffmpeg-refactor.md)
