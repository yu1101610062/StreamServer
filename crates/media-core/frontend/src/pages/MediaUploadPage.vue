...
import { CopyDocument, Delete, Link, Refresh, Upload, UploadFilled } from "@element-plus/icons-vue";
  ...
  <section class="page-grid">
    ...
    <div v-if="uploadResult" class="surface-card">
      ...
      <div class="table-actions upload-actions">
        ...
        <el-link type="primary" :href="uploadResult.httpUrl" target="_blank" rel="noreferrer">
